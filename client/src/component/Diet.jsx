...
export default function Diet() {
    ...
    useEffect(() => {
        fetch(`https://galwin-7487fa6a2294.herokuapp.com/track/${loggedUser.userid}/${currentDateView.getMonth() + 1}-${currentDateView.getDate()}-${currentDateView.getFullYear()}`, {
            method: "GET",
            headers: {
    ...
    function deleteFood(itemId) {
        return fetch(`https://galwin-7487fa6a2294.herokuapp.com/track/${itemId}`, {
            method: "DELETE",
            headers: {
                "Authorization": `Bearer ${loggedUser.token}`
            }
